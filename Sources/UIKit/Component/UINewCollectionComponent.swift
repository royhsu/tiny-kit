...
public final class UINewCollectionComponent: Component {
...
public extension UINewCollectionComponent {

    public typealias NumberOfSectionsHandler = UICollectionViewBridge.NumberOfSectionsHandler
    
    @discardableResult
    public final func setNumberOfSections(_ handler: NumberOfSectionsHandler?) -> UINewCollectionComponent {
    ...
    @discardableResult
    public final func setNumberOfItems(_ handler: NumberOfItemsHandler?) -> UINewCollectionComponent {
    ...
    @discardableResult
    public final func setComponentForItem(_ handler: ComponentForItemHandler?) -> UINewCollectionComponent {
